            ...
            <View style={styles.container}>
                <View style={styles.absoluteView}>
                    ...
                    <ScrollView style={styles.mainContainer}>
                        ...
                        <View style={styles.anotherGridView}>
                            <Text style={styles.anotherGridText}>Another Grid Section</Text>
                        </View>
                        ...
                        <FlatList
                            ...
                            renderItem={({ item, index }) => (
                                <TouchableOpacity style={styles.otherProductView} key={index} onPress={() => Actions.beverages_screen4()}>
